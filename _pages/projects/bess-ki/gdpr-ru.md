...
Собранные данные будут проанализированы в ходе нескольких исследований, поэтому необходимо их длительное хранение. Собранные языковые данные будут храниться локально и надежно в течение 10 лет в рамках запланированного исследования. Мы гарантируем, что все данные всегда будут обрабатываться в рамках внутренней инфраструктуры университета. В случае необходимости привлечения внешних партнеров для выполнения специализированных задач, таких как аннотирование данных, это будет осуществляться только в строгом соответствии с нормами защиты данных и в рамках четко определенных договорных соглашений.

Записи голоса используются в первом исследовании, чтобы выяснить, возможно ли в целом поддерживать вступительные экзамены в школу с помощью методов автоматической обработки речи. Также проводится статистический анализ личных данных, таких как возраст, пол и родной язык родителей. В дальнейшем будет проанализирована степень влияния диалектных различий на исследуемые системы. В этой части исследования анализируются личные данные, в частности родной язык. В последующем исследовании с помощью записей голоса анализируются различные методы автоматической обработки языка с целью достижения максимально возможной поддержки. Последующее исследование посвящено вопросу о том, позволяют ли найденные методы делать выводы о детальных аспектах развития языка на основе записей речи. Наконец, записи речи используются для анализа объяснимости моделей/методов, найденных в предыдущих исследованиях. Результаты соответствующих исследований публикуются в виде результатов исследования, при этом выводы об отдельных людях исключаются путем псевдонимизации данных.  Оригинальные записи голоса ни в коем случае не публикуются.
...
- что данные хранятся в течение 10 лет и анализируются несколько раз в рамках нескольких исследований,
